...
<div class="span11">
		...
		<div class="weixin">
			    ...
			    <img id="ewm" style="display:none;" src="${pageContext.request.contextPath}/image/trimImg/myWX.jpeg" alt="微信图标" class="weixin-ewm"/>
		</div> --%>
</div>
<div class="container header">
	<div class="span5">
		<div class="logo">
				<img id="logoPic" src="${pageContext.request.contextPath}/image/trimImg/log.jpg" style="display: block;width: 200px;margin-top: -11px;" alt="小家电商城"/>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
	...
	<div class="span24">
		<ul class="mainNav">
					...
					<li>
						<a href="${pageContext.request.contextPath}/shop/puffingType?type=1">冰箱类</a>
						|
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/shop/puffingType?type=2">电脑类</a>
						|
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/shop/puffingType?type=3">电视机类</a>
						|
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/shop/puffingType?type=6">空调类</a>
						|
					</li>
					<li>
...
<div class="container index">
		    <div  class="span24" style="height: 456px;">
			    	...
			    	<img id="lb1"   src="${pageContext.request.contextPath}/image/trimImg/lb1.jpg" style="display: block;width:1000px;"/>
			    	<img id="lb2"   src="${pageContext.request.contextPath}/image/trimImg/lb2.jpg" style="display: none;width:1000px;"/>
			    	<img id="lb3"   src="${pageContext.request.contextPath}/image/trimImg/lb3.jpg" style="display: none;width:1000px;"/>
		    </div>
		<div class="span24">
...
<div class="container footer">
	<div class="span24">
		<div class="copyright">【光衡商城】 版权所有</div>
	</div>
</div>
