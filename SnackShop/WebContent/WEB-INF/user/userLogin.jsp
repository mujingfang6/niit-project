...
<div class="container header">
	<div class="span5">
		<div class="logo">
				<img id="logoPic" src="${pageContext.request.contextPath}/image/trimImg/log.jpg" style="display: block; width: 200px;margin-top: -11px;" alt="食尚零食"/>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
...
<div class="span12">
<div class="ad">
					<img src="${pageContext.request.contextPath}/image/trimImg/book3.jpg" width="500" height="330" alt="会员登录" title="会员登录" />
</div>		</div>
